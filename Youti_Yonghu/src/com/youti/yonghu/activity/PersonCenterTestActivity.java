...
public class PersonCenterTestActivity extends FragmentActivity implements OnClickListener{
	...
	int screenWidth;
	View indicate_line;
	ImageView iv_send_add,iv_near,sex,iv_back,iv_vip;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(sp.getString("ton_id", "0").equals("1")){
			iv_vip.setImageResource(R.drawable.grzy_vip30);
		}else if(sp.getString("ton_id", "0").equals("2")){
			iv_vip.setImageResource(R.drawable.grzy_vip90);
		}else if(sp.getString("ton_id", "0").equals("3")){
			iv_vip.setImageResource(R.drawable.grzy_vip180);
		}else if(sp.getString("ton_id", "0").equals("0")){
		...
		HttpUtils.post("http://112.126.72.250/ut_app/index.php?m=User&a=click_head", params, new TextHttpResponseHandler() {
			...
			public void onSuccess(int arg0, Header[] arg1, String arg2) {
				...
				if(userCenterBean.code.equals("1")){
					...
					Utils.showToast(PersonCenterTestActivity.this, "连接失败");
				}
			}
		...
		hlv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(position==photoList.size()){
					if(photoList.size()>8){
						Utils.showToast(PersonCenterTestActivity.this, "最多上传9张图片,请长按相片点击删除");
						return;
					}
					//打开相册，选择照片
					...
					if(isFirstClikcPhoto){
						//小U提示，长按可以点击删除相片
						final Dialog okDialog =new Dialog(PersonCenterTestActivity.this,R.style.tkdialog);
						View okView=View.inflate(PersonCenterTestActivity.this, R.layout.dialog_ok, null);
...
//						Utils.showToast(PersonCenterActivity.this, photoList.size()+"");
						Intent intent =new Intent(PersonCenterTestActivity.this,PhotoShowActivity.class);
		...
		hlv.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				if(position==photoList.size()){
					...
					final Dialog deletePhotoDialog =new Dialog(PersonCenterTestActivity.this, R.style.tkdialog);
					View v =View.inflate(PersonCenterTestActivity.this, R.layout.layout_contactservice, null);
	...
	protected void deletePhoto(final int position) {
		...
		createProgressBarDialog2 = Utils.createProgressBarDialog(PersonCenterTestActivity.this, "正在删除...");
		...
		HttpUtils.post(urlDel, params, new JsonHttpResponseHandler(){
			...
			public void onFailure(int statusCode, Header[] headers,
				...
				Utils.showToast(PersonCenterTestActivity.this, "删除失败");
			}
			...
			public void onSuccess(int statusCode, Header[] headers,
				...
				try {
					...
					if(code.equals("1")){
						...
						Utils.showToast(PersonCenterTestActivity.this, "删除照片成功");
					}
	...
	class MyHLVAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View v =View.inflate(PersonCenterTestActivity.this, R.layout.item_xiangce, null);
	...
	Handler handler= new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			...
			case SUCCESS:
				...
				if(userCenterBean.list.ton.equals("30")){
					iv_vip.setImageResource(R.drawable.grzy_vip30);
				}else if(userCenterBean.list.ton.equals("90")){
					iv_vip.setImageResource(R.drawable.grzy_vip90);
				}else if(userCenterBean.list.ton.equals("180")){
					iv_vip.setImageResource(R.drawable.grzy_vip180);
				}else if(userCenterBean.list.ton.equals("")){
					iv_vip.setVisibility(View.GONE);
				}else{
					iv_vip.setVisibility(View.GONE);
				}
	...
	public void showImagePickDialog(final boolean b) {
		...
		final Dialog selectDialog = new Dialog(PersonCenterTestActivity.this, R.style.tkdialog);
		View v =View.inflate(PersonCenterTestActivity.this, R.layout.dialog_getimage, null);
    ...
    public void onActivityResult(final int requestCode, final int resultCode,
        ...
        case PHOTO_PICKED_WITH_DATA:
        	 selectedImageUri = imageReturnIntent.getData(); 
        	 pathTest = selectedImageUri.toString();
        	 uploadNewPhoto1(false);
        	 break;
        case CAPTURE_IMAGE_ACTIVITY_REQUEST_CODE: 	
     		pathTest=picFileFullName;
     		uploadNewPhoto1(true);
        	break;
     ...
     * @param b 
     */
    private void uploadNewPhoto1(final boolean b) {
    	 if (!TextUtils.isEmpty(pathTest)) {
    		 RequestParams params =new RequestParams();
          	 params.put("user_id", user_id);
          	Bitmap upBitmap=null;
          	 if(b){
          		 
          		upBitmap= BitmapFactory.decodeFile(pathTest);
          	 }else{
          		 
    		   upBitmap = ImageLoader.getInstance().loadImageSync(pathTest);
          	 }
        	 ...
        	 if(b){
        		 up.setPhoto_url("file:///"+pathTest);
        	 }else{
        		 
        		 up.setPhoto_url(pathTest);
        	 }
        	HttpUtils.post("http://112.126.72.250/ut_app/index.php?m=User&a=upload_photo", params, new JsonHttpResponseHandler() {
                public void onStart() {  
                    super.onStart(); 
                    createProgressBarDialog = Utils.createProgressBarDialog(PersonCenterTestActivity.this, "正在上传相片...");
                ...
                public void onFailure(int statusCode,
                	 ...
                	 Utils.showToast(PersonCenterTestActivity.this, "上传失败");
                };
                public void onFinish() {
                };
                public void onSuccess(int statusCode,
                    ...
                    try {
                    	...
                    	if(state.equals("1")){
                    		Utils.showToast(PersonCenterTestActivity.this, response.toString()+":"+capturePath);
                    		System.out.println(response.toString()+":"+pathTest);
                    		String photo_id=response.getJSONObject("list").getString("photo_id");
                    		up.setPhoto_id(photo_id);
                    		photoList.add(0,up);
                    		if(b){
                    			
                    			photoList1.add(0,"file:///"+pathTest);
                    		}else{
                    			photoList1.add(0,pathTest);
                    		}
                    		Utils.showToast(PersonCenterTestActivity.this, pathTest);
                    		System.out.println(pathTest);
                    		hlv.setAdapter(new MyHLVAdapter(photoList));
                    	//	Utils.showToast(PersonCenterTestActivity.this, "上传成功");
                    	}else{
                    		Utils.showToast(PersonCenterTestActivity.this, response.getString("上传失败"));
                    	}
                    } catch (Exception e) {
         	...
         	Utils.showToast(PersonCenterTestActivity.this, "图像不存在，上传失败");
         }
      ...
      //  showWaitDialog("正在上传头像...");
        ...
        if (protraitBitmap != null) {
        	...
        	HttpUtils.post("http://112.126.72.250/ut_app/index.php?m=User&a=upload_head", params, new JsonHttpResponseHandler() {
				public void onStart() {  
                    super.onStart(); 
                    createProgressBarDialog = Utils.createProgressBarDialog(PersonCenterTestActivity.this, "正在上传头像...");
                    createProgressBarDialog.show();
