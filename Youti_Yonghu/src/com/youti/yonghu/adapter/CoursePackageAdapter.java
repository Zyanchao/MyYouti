...
public class CoursePackageAdapter extends BaseAdapter<ClassPackage, CoursePackageAdapter.CoursePackage >{

	
	public CoursePackageAdapter(Context context, List<ClassPackage> list) {
		super(context, list);
	...
	@Override
	protected void initHolderByBean(ClassPackage bean, CoursePackage holder) {
		holder.name.setText(bean.getYouhui_desc());
