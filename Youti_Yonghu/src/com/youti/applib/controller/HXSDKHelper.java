 ...
 */
package com.youti.applib.controller;
...
import com.youti.applib.model.DefaultHXSDKModel;
import com.youti.applib.model.HXNotifier;
import com.youti.applib.model.HXNotifier.HXNotificationInfoProvider;
import com.youti.applib.model.HXSDKModel;
/**
 ...
 * 
 * �?发人员可以�?�择继承这个环信SDK帮助类去加快初始化集成�?�度。此类会初始化环信SDK，并设置初始化参数和初始化相应的监听�?
 * 不过继承类需要根据要求求提供相应的函数，尤其是提供一个{@link HXSDKModel}. �?以请实现abstract protected HXSDKModel createModel();
 * 全局仅有�?个此类的实例存在，所以可以在任意地方通过getInstance()函数获取此全�?实例
 * 
 * @author easemob
 *
 */
