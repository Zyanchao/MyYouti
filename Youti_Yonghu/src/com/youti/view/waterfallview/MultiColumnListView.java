...
package com.youti.view.waterfallview;
...
public class MultiColumnListView extends PLA_ListView {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.waterfalllistview);

            int landColNumber = a.getInteger(R.styleable.waterfalllistview_plaLandscapeColumnNumber, 3);
           //改变这个值，可以让其在竖屏为3列，4列等
            int defColNumber = a.getInteger(R.styleable.waterfalllistview_plaColumnNumber, 2);
            //在这里判断的是横屏还是竖屏 下面这个条件是横屏
            ...
            mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.waterfalllistview_plaColumnPaddingLeft, 0);
            mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.waterfalllistview_plaColumnPaddingRight, 0);
            a.recycle();
        }
