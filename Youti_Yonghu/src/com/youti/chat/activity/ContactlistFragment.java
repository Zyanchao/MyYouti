...
public class ContactlistFragment extends Fragment {
		...
		new Thread(new Runnable() {
			public void run() {
				try {
					...
					YoutiApplication.getInstance().getContactList().remove(tobeDeleteUser.getUsername());
	...
	private void getContactList() {
		contactList.clear();
		//获取本地好友列表
		Map<String, User> users = YoutiApplication.getInstance().getContactList();
